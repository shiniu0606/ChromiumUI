 ...
 */
class CHROMIUMUI_API IChromiumWebBrowserSchemeHandler
{
public:
	/**
	 * An interface for setting response headers emulating a http implementation.
	 */
	class IChromiumHeaders
	{
	public:
		/**
...
public:
	virtual ~IChromiumWebBrowserSchemeHandler() {}
	 ...
	 */
	virtual void GetResponseHeaders(IChromiumHeaders& OutHeaders) = 0;
 ...
 */
class CHROMIUMUI_API IChromiumWebBrowserSchemeHandlerFactory
{
public:
	virtual ~IChromiumWebBrowserSchemeHandlerFactory() {}
	 ...
	 * @param   Url             This is the full url for the request being made.
	 */
	virtual TUniquePtr<IChromiumWebBrowserSchemeHandler> Create(FString Verb, FString Url) = 0;
};
