...
class CHROMIUMUI_API SChromiumWebBrowser
	: public SCompoundWidget
{
public:
	DECLARE_DELEGATE_RetVal_TwoParams(bool, FOnBeforeBrowse, const FString&, const FChromiumWebNavigationRequest& /*Request*/)
	...
	SLATE_BEGIN_ARGS(SChromiumWebBrowser)
...
private:
	...
	bool HandleCloseWindow(const TWeakPtr<IChromiumWebBrowserWindow>& BrowserWindowPtr);
private:

	/** The actual web browser view */
	TSharedPtr<SChromiumWebBrowserView> BrowserView;

	TSharedPtr<IChromiumWebBrowserWindow> BrowserWindow;

#if UE_BUILD_DEVELOPMENT || UE_BUILD_DEBUG
	TMap<TWeakPtr<IChromiumWebBrowserWindow>, TWeakPtr<SWindow>> BrowserWindowWidgets;
#endif
