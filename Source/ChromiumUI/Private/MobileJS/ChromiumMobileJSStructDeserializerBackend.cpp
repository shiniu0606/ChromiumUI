...
bool FChromiumMobileJSStructDeserializerBackend::ReadProperty( FProperty* Property, FProperty* Outer, void* Data, int32 ArrayIndex )
{
		...
		case EJsonNotation::String:
		{
			if (Property->IsA<FStructProperty>())
			{
				...
				if ( StructProperty->Struct == FChromiumWebJSFunction::StaticStruct())
				{
					...
					return SetPropertyValue<FStructProperty, FChromiumWebJSFunction>(Property, Outer, Data, ArrayIndex, CallbackObject);
				}
			}
		}
		break;
...
FChromiumMobileJSStructDeserializerBackend::FChromiumMobileJSStructDeserializerBackend(FChromiumMobileJSScriptingRef InScripting, const FString& JsonString)
