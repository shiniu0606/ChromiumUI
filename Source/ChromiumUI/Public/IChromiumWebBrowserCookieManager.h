...
struct FChromiumWebBrowserCookie
{
public:
	// The cookie name.
	FString Name;
...
{
public:
	typedef struct FChromiumWebBrowserCookie FChromiumCookie;
public:
	 ...
	 */
	virtual void SetCookie(const FString& URL, const FChromiumCookie& Cookie, TFunction<void(bool)> Completed = nullptr) = 0;
