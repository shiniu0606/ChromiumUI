...
class FChromiumCEFTextInputMethodContext;
class ITextInputMethodChangeNotifier;
class SWidget;

class FChromiumCEFImeHandler
	: public TSharedFromThis<FChromiumCEFImeHandler>
{
public:
	FChromiumCEFImeHandler(CefRefPtr<CefBrowser> Browser);
...
private:
	...
	TSharedPtr<FChromiumCEFTextInputMethodContext> TextInputMethodContext;
	...
	friend class FChromiumCEFTextInputMethodContext;
};
