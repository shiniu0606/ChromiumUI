...
class FChromiumCEFWebBrowserDialog
	: public IChromiumWebBrowserDialog
{
public:
	virtual ~FChromiumCEFWebBrowserDialog()
	{}
	...
	{
		check(Type == EChromiumWebBrowserDialogType::Prompt || UserResponse.IsEmpty());
...
private:
	...
	FChromiumCEFWebBrowserDialog(CefJSDialogHandler::JSDialogType InDialogType, const CefString& InMessageText, const CefString& InDefaultPrompt, CefRefPtr<CefJSDialogCallback> InCallback)
		: Type((EChromiumWebBrowserDialogType)InDialogType)
	...
	FChromiumCEFWebBrowserDialog(const CefString& InMessageText, bool InIsReload, CefRefPtr<CefJSDialogCallback> InCallback)
		: Type(EChromiumWebBrowserDialogType::Unload)
		, MessageText(FText::FromString(WCHAR_TO_TCHAR(InMessageText.ToWString().c_str())))
	...
	friend class FChromiumCEFWebBrowserWindow;
};

typedef FChromiumCEFWebBrowserDialog FChromiumWebBrowserDialog;
