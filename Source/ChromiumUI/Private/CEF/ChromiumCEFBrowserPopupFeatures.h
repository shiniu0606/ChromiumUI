...
class FChromiumCEFBrowserPopupFeatures
	: public IChromiumWebBrowserPopupFeatures
{
public:
	FChromiumCEFBrowserPopupFeatures();
	FChromiumCEFBrowserPopupFeatures(const CefPopupFeatures& PopupFeatures);
	virtual ~FChromiumCEFBrowserPopupFeatures();
