 ...
 */
class FChromiumCefSchemeHandlerFactories
{
public:
	/**
	 ...
	 */
	void AddSchemeHandlerFactory(FString Scheme, FString Domain, IChromiumWebBrowserSchemeHandlerFactory* WebBrowserSchemeHandlerFactory);
	 ...
	 */
	void RemoveSchemeHandlerFactory(IChromiumWebBrowserSchemeHandlerFactory* WebBrowserSchemeHandlerFactory);
