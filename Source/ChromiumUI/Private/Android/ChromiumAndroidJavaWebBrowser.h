...
class FChromiumJavaAndroidWebBrowser : public FJavaClassObject
{
public:
	FChromiumJavaAndroidWebBrowser(bool swizzlePixels, bool vulkanRenderer, int32 width, int32 height, jlong widgetPtr, bool bEnableRemoteDebugging, bool bUseTransparency);
	virtual ~FChromiumJavaAndroidWebBrowser();
	void Release();
