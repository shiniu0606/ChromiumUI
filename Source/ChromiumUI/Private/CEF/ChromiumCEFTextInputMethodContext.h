...
class FChromiumCEFTextInputMethodContext : public ITextInputMethodContext
{
public:

	virtual ~FChromiumCEFTextInputMethodContext() {}

	static TSharedRef<FChromiumCEFTextInputMethodContext> Create(const TSharedRef<FChromiumCEFImeHandler>& InOwner);
...
private:
	FChromiumCEFTextInputMethodContext(const TSharedRef<FChromiumCEFImeHandler>& InOwner);
	TSharedRef<FChromiumCEFImeHandler> Owner;
