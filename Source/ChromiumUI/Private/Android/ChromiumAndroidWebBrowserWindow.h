...
class SChromiumWebBrowserView;

/**
* Implementation of interface for dealing with a Web Browser window.
*/
class FChromiumAndroidWebBrowserWindow
	: public IChromiumWebBrowserWindow
	, public TSharedFromThis<FChromiumAndroidWebBrowserWindow>
{
...
private:
	 ...
	 */
	FChromiumAndroidWebBrowserWindow(FString Url, TOptional<FString> ContentsToLoad, bool bShowErrorMessage, bool bThumbMouseButtonNavigation, bool bUseTransparency, bool bJSBindingToLoweringEnabled);
...
public:
	/** Virtual Destructor. */
	virtual ~FChromiumAndroidWebBrowserWindow();
...
public:
	...
	DECLARE_DERIVED_EVENT(FAndroidWebBrowserWindow, IChromiumWebBrowserWindow::FOnDocumentStateChanged, FOnDocumentStateChanged);
	virtual FOnDocumentStateChanged& OnDocumentStateChanged() override
	{
		return DocumentStateChangedEvent;
	}

	DECLARE_DERIVED_EVENT(FAndroidWebBrowserWindow, IChromiumWebBrowserWindow::FOnTitleChanged, FOnTitleChanged);
	virtual FOnTitleChanged& OnTitleChanged() override
	{
		return TitleChangedEvent;
	}

	DECLARE_DERIVED_EVENT(FAndroidWebBrowserWindow, IChromiumWebBrowserWindow::FOnUrlChanged, FOnUrlChanged);
	virtual FOnUrlChanged& OnUrlChanged() override
	{
		return UrlChangedEvent;
	}

	DECLARE_DERIVED_EVENT(FAndroidWebBrowserWindow, IChromiumWebBrowserWindow::FOnToolTip, FOnToolTip);
	virtual FOnToolTip& OnToolTip() override
	{
		return ToolTipEvent;
	}

	DECLARE_DERIVED_EVENT(FAndroidWebBrowserWindow, IChromiumWebBrowserWindow::FOnNeedsRedraw, FOnNeedsRedraw);
	...
	DECLARE_DERIVED_EVENT(FAndroidWebBrowserWindow, IChromiumWebBrowserWindow::FOnShowPopup, FOnShowPopup);
	virtual FOnShowPopup& OnShowPopup() override
	{
		return ShowPopupEvent;
	}

	DECLARE_DERIVED_EVENT(FAndroidWebBrowserWindow, IChromiumWebBrowserWindow::FOnDismissPopup, FOnDismissPopup);
...
private:
	...
	TSharedPtr<SChromiumAndroidWebBrowserWidget> BrowserWidget;
	...
	FChromiumMobileJSScriptingPtr Scripting;
...
typedef FChromiumAndroidWebBrowserWindow FChromiumWebBrowserWindow;
